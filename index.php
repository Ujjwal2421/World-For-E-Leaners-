...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">Welcome to E-Learners World</h1>
        <small class="my-content">Learn and Innovate </small><br />
        <?php    
    ...
    <div class="container-fluid bg-danger"> <!-- Start Social Follow -->
        <div class="row text-white text-center p-1">
          ...
          <div class="col-sm">
            <a class="text-white social-hover" href="https://twitter.com/Ujjwal33631720" target="."><i class="fab fa-twitter"></i> Twitter</a>
          </div>
          <div class="col-sm">
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>E-Learners provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>E-Learners Pvt Ltd <br>  <br>DELHI <br> Ph. +XXXXXXXXX </p>
          </div>
        </div>
      </div>
